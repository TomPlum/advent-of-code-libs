...
| <pre lang="kotlin"><L, R> Collection<String>.toVerticalLists(<br/>parse: (String) -> Pair<L, R>?<br/>): Pair<MutableList<L>, MutableList<R>></pre> | Parses a collection of Strings (Usually puzzle input lines) vertically to produce two lists.                                                                                                                                                                                                                                                                                                      |
